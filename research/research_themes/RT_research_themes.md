...
|---|---|---|
| **[Real-World RL]({{ site.data.links.RT_real_world_rl }})** | critic, and policy when explicitly parameterized | learn task-domain value and decision structure from selected real transitions |
| **[Online Multistep Lookahead]({{ site.data.links.RT_online_multistep_lookahead }})** | online action sequence and progressively learned solution policy | hold a terminal critic fixed while online lookahead improves the current action |
| **[Semantic Critic Learning]({{ site.data.links.RT_semantic_critic_learning }})** | semantic supervision and critic | use accepted semantic information to teach the critic before policy improvement |
| **[Nonstationary Infinite-Horizon OCP]({{ site.data.links.RT_nonstationary_infinite_horizon_ocp }})** | context-augmented reference problem | recover a time-homogeneous Bellman formulation when sufficient context exists |
| **[Continual Model Learning]({{ site.data.links.RT_continual_model_learning }})** | dynamics model and, when needed, state trajectory | fit new operating information while retaining prior control-relevant model behavior |
| **[Constrained PINN]({{ site.data.links.RT_constrained_pinn }})** | physics field or model and dual variables | represent selected physical requirements as explicit learning constraints |
| **[Neuro-Adaptive Control]({{ site.data.links.RT_neuro_adaptive_control }})** | policy parameter | adapt an uncertain ideal feedback-law approximation directly from closed-loop signals |
| **[Structured Critic Adaptation]({{ site.data.links.RT_structured_critic_adaptation }})** | environment estimate and critic configuration | reuse a critic family by identifying a compact condition rather than relearning the full critic |
...
- **[Real-World RL]({{ site.data.links.RT_real_world_rl }})** — update critic and, when explicitly
...
- **[Online Multistep Lookahead]({{ site.data.links.RT_online_multistep_lookahead }})** — fix the
...
- **[Semantic Critic Learning]({{ site.data.links.RT_semantic_critic_learning }})** — use semantics
...
- **[Nonstationary Infinite-Horizon OCP]({{ site.data.links.RT_nonstationary_infinite_horizon_ocp }})**
...
- **[Continual Model Learning]({{ site.data.links.RT_continual_model_learning }}):** jointly fit
...
- **[Constrained PINN]({{ site.data.links.RT_constrained_pinn }}):** learn complex
...
- **[Neuro-Adaptive Control]({{ site.data.links.RT_neuro_adaptive_control }}):** instead of first
...
- **[Structured Critic Adaptation]({{ site.data.links.RT_structured_critic_adaptation }}):** an
