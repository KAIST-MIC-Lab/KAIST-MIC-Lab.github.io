...
title: "Mixed-Modality Stimulation to Evoke Two Modalities Simultaneously in One Channel for Electrocutaneous Sensory Feedback" # Title of the paper
...
pub: # Publication information - REMOVE THIS FIELD IF NOT APPLICABLE!
  - name: "IEEE Transactions on Neural Systems and Rehabilitation Engineering"
    doi: "10.1109/TNSRE.2017.2730856" # Leave it blank if not applicable
    vol: "52" # Leave it blank if not applicable
    no: "12" # Leave it blank if not applicable
    pp: "2258-2269" # Leave it blank if not applicable
    year: "2017" # Leave it blank if not applicable
    state: "published" # published, accepted, submitted
pub_date: "2017-05-01" # Date of publication. Change Techrxiv (or other preprint) date to Journal date once published.
image: "/static/pub/2017-mixed-modality.png" # Representative image of the paper
abstract: "
