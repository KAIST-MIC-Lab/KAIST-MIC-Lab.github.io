...
title: "Current sensorless state of charge estimation approach for onboard battery systems with an unknown current estimator" # Title of the paper
krtitle: # only for domestic papers
authors: "Wooyong Kim, <u>Kyunghwan Choi#42;</u>"
domestic_or_international: "International" # "International" or "Domestic"
pubs: # Publication information - REMOVE THIS FIELD IF NOT APPLICABLE!
  - name: "Journal of Energy Storage"
    doi: "10.1016/j.est.2022.104726" # Leave it blank if not applicable
...
pub_date: "2022-08-01" # Date of publication. Change Techrxiv (or other preprint) date to Journal date once published.
image: "/static/pub/2022-current-charge.png" # Representative image of the paper
abstract: "
