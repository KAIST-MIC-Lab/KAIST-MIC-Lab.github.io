...
title: "Synthesis of a Link-Level Energy-Time Predictor Toward the Implementation of a Link-based Predictive EMS" # Title of the paper
...
pub: # Publication information - REMOVE THIS FIELD IF NOT APPLICABLE!
  - name: "IEEE Access (Early Access)"
    pdf: # "/static/pub/2026-vector-space.pdf"
    doi: 10.1109/ACCESS.2026.3726602 # Leave it blank if not applicable
...
pub_date: "2026-08-24" # Date of publication. Change Techrxiv (or other preprint) date to Journal date once published.
image: "/static/pub/2026-synthesis-of.png" # Representative image of the paper
