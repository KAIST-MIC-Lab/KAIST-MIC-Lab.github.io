...
pub: # Publication information - REMOVE THIS FIELD IF NOT APPLICABLE!
  - name: "Advanced Intelligent Systems"
    doi: "10.1002/aisy.202400797" # Leave it blank if not applicable
    vol:  # Leave it blank if not applicable
    num:  # Leave it blank if not applicable
    pp: "2400797" # Leave it blank if not applicable
    year: "2025" # Leave it blank if not applicable
    state: "published" # published, accepted, submitted
pub_date: "2025-04-10" # Date of publication. Change Techrxiv (or other preprint) date to Journal date once published.
image: "/static/pub/2025-cooperative-merging.png" # Representative image of the paper
abstract: "
